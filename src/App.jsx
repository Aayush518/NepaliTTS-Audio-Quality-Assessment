  ...
  <p className="intro">
    ...
    Your input will help us refine and enhance the speech synthesis technology for better user experience. Thank you for your time and support!
      ...
      <footer className="footer">
        <p>© 2025 Audio Quality Assessment | Text-to-Speech Research Project</p>
      </footer>
    </div>
  );
}
...
function RatingForm({ sample, rating, listened, onRate, onListen, animationDelay }) {
  ...
  // Add inline style for staggered animation
...
// To integrate with Google Sheets, you'll need to set up:
// 1. A Google Cloud project
// 2. Enable Google Sheets API
// 3. Create service account credentials
// 4. Create a server-side API endpoint that uses these credentials

// Below is a Node.js example endpoint using Express and the Google Sheets API
...
app.post('/api/submit-feedback', async (req, res) => {
  try {
    ...
    const data = [
      ...
      req.body.userInfo.age,
      req.body.userInfo.gender,
      req.body.userInfo.district,
      req.body.ratings.sample1,
      req.body.ratings.sample2, 
      req.body.ratings.sample3,
      req.body.ratings.sample4,
      req.body.ratings.sample5
    ];
